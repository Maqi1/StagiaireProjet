...
public class InterfaceAjoutStagiaireCtrl {
    ...
    //je rappel ma varibale afin d'afficher la liste stagiaire
	...
	if (erreurs.isEmpty()) {
	    ...
	    // a l'ajout je reçois un message d'alerte
	    ...
	    // une fois ajouter la console vide les info de ma console 
	    this.nomS.clear();
	    this.prenomS.clear();
	    this.dptS.clear();
	    this.promoS.clear();
